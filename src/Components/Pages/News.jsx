...
function News() {
  return (
    <div className='bg-zinc-800 relative h-full w-full max-w-[700px] transition-all p-2 overflow-auto bgimage'>
      <img src={bgimage} className='fixed top-0 left-0 w-full h-full object-cover opacity-15' />

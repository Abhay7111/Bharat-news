    ...
    <div className="w-full p-7 max-w-2xl mx-auto bg-gradient-to-br from-blue-950 via-zinc-900 to-zinc-800 rounded-3xl shadow-2xl mt-10 border border-blue-900/40 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="text-3xl font-black mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-600 tracking-tight drop-shadow-lg">
          <i className="ri-robot-2-line mr-2 text-4xl align-middle" />
        ...
        <form onSubmit={handleSubmit} className="space-y-7">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                className="w-full border border-blue-800 bg-zinc-900/80 text-zinc-100 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition placeholder:text-zinc-400 shadow-inner"
                type="text"
                id="question"
                name="question"
            ...
            <div>
              ...
              <input
                className="w-full border border-blue-800 bg-zinc-900/80 text-zinc-100 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 transition placeholder:text-zinc-400 shadow-inner"
                type="text"
                id="category"
                name="category"
          ...
          <div>
            ...
            <textarea
              className="w-full border border-blue-800 bg-zinc-900/80 text-zinc-100 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition min-h-[90px] resize-y placeholder:text-zinc-400 shadow-inner"
              id="answer"
              name="answer"
              ...
              {formData.image && (
                <div className="mt-2 flex items-center gap-2">
                  <img
                    src={formData.image}
                    alt="Preview"
                    className="h-14 w-14 object-cover rounded-lg border border-blue-800 shadow"
          ...
          <button
            type="submit"
            className={`w-full py-3 rounded-xl font-bold text-lg transition flex items-center justify-center gap-2 shadow-lg
              ${status === 'loading'
